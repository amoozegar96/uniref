...
$(function () {
    ...
    $("#IranMap .list .province   a").hover(function () {
        var e = $(this).parent("li").attr("class").replace("col-xl-4 col-lg-6 col-md-12 col-sm-12 p-1 ","");
        var c =  "province";
        var b = "#IranMap svg g.province path." + e;
        var d = $(b).attr("class");
        $(b).attr("class", d + " hover")
    }, function () {
        var e = $(this).parent("li").attr("class").replace("col-xl-4 col-lg-6 col-md-12 col-sm-12 p-1 ","");
        var c = $(this).parents(".province").attr("class").replace(" d-flex flex-wrap");
        var b = "#IranMap svg g.province path." + e;
        var d = $(b).attr("class");
